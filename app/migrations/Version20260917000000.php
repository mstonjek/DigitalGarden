...
/**
 * Initial schema: user + flower tables.
 * GitHub may return email: null (private email), hence the nullable column.
 */
final class Version20260917000000 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Initial DigitalGarden schema';
    }
